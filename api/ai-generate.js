module.exports = async function handler(req, res) {
    ...
    const systemPrompt = `تو یک دستیار فروش حرفه‌ای ایرانی هستی. وظیفه‌ات کمک به فروشنده‌ها برای نوشتن پیام‌های فروش مؤثر است.
...
- اگه لینک عکس محصول در پیام بود، لینک رو کامل و بدون تغییر توی خط آخر بنویس (نباید بخشی از لینک رو حذف کنی)
